...
public class RepositorySorters {
        ...
        switch (comparisonType) {
            case "ascending":
                return new Comparator<Map.Entry<String, ArrayList<Integer>>>() {
                    @Override
                    public int compare(Map.Entry<String, ArrayList<Integer>> firstStudent, Map.Entry<String, ArrayList<Integer>> secondStudent) {
    ...
    private static Double getTotalScore(ArrayList<Integer> marks) {
        double total = 0;
