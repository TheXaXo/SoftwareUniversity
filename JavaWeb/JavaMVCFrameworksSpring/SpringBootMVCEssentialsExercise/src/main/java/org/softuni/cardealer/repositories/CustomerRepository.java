...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    List<Customer> findAllByBirthDateAsc();

    @Query("SELECT c FROM Customer AS c ORDER BY c.birthDate DESC, c.isYoungDriver ASC")
    List<Customer> findAllByBirthDateDesc();
